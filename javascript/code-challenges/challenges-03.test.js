...
const typeNum = (arr) => {
  const newArray = arr.filter(element => typeof(element) === 'number');
  return newArray;
  // Solution code here...
};
...
const oddValues = (arr) => {
  const oddArray = arr.filter(odds => odds % 2 === 1);
  return oddArray;
  // Solution code here...
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  const newArray = arr.filter(element => !forbiddenValues.includes(element));
  return newArray;
  // Solution code here...
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  const newArray = arr.filter(element => element.baseStat > minBaseStat);
  return newArray;
  // Solution code here...
};
...
const getStatName = (arr, minBaseStat) => {
  const newArray = getBaseStatGreaterThan(arr, minBaseStat).filter(element => element.stat.name);
  return newArray;
