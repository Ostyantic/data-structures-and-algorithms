...
const raisedToTheThird = (arr) => {
  const nArray = [];
  arr.forEach(number => nArray.push(Math.pow(number, 3)));
  return nArray;
};
...
const addQuestion = (arr) => {
  const nArray = arr.map(string => `${string}?`);
  return nArray;
};
...
const forEachTwoToThe = (arr) => {
  const nArray = [];
  arr.forEach(num => nArray.push(Math.pow(2, num)));
  return nArray;
  // Solution code here...
};
...
const mapTwoToThe = (arr) => {
  const nArray = arr.map(num => Math.pow(2, num));
  return nArray;
};
...
const charCode = (arr) => {
  const nArray = arr.map(letter => letter.charCodeAt());
  return nArray;
  // Solution code here...
};
